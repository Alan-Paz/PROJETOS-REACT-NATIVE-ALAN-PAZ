...
const handlerInputs = () => {
 ...
 <Text style={styles.footer}>Desenvolvido por ALAN PAZ </Text>
 </View>
        )}
        {showAbout && (
          <View style={styles.container}>
            ...
            <Button onPress={() => Linking.openURL("")} mode="contained" style={styles.button} color="#bababa" icon={'account-details'}>Sobre o autor</Button>
